...
class Produto {
    ...
    public function consulta() {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, 
        valor, disponibilidade FROM $this->tabela";
    ...
    public function consultaID($id) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE id = :id";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorCategoria($categoria) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE categoria = :categoria";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorNome($nome) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE nome LIKE :nome";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorIdade($idade) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE idade LIKE :idade";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorEstudio($estudio) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE estudio LIKE :estudio";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorValorMenor($valor) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE valor < :valor";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorValorEntre($min, $max) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE valor BETWEEN :min AND :max";
        $stmt = $this->pdo->prepare($sql);
    ...
    public function consultaPorDisponibilidade($disp) {
        $sql = "SELECT id, nome, imagem, estudio, categoria, idade, valor, 
        disponibilidade FROM $this->tabela WHERE disponibilidade = :disp";
        $stmt = $this->pdo->prepare($sql);
